package com.ylg.panel.js.circle;
...
import com.ylg.panel.js.views.WrapContentWidthViewPager;
...
public class ImageCycleView extends LinearLayout {
	 ...
	 * 图片轮播视图
	 */
	private WrapContentWidthViewPager mAdvPager = null;
	/**
	 * 滚动图片视图适配
	 */
	...
	private void init(Context context) {
		...
		mAdvPager = (WrapContentWidthViewPager) findViewById(R.id.adv_pager);
	 ...
	 *
	 */
	public void setImageResources(ArrayList<String> imageDesList, ArrayList<Integer> imageUrlList, ImageCycleViewListener imageCycleViewListener) {
	...
	private class ImageCycleAdapter extends PagerAdapter {
		...
		public ImageCycleAdapter(Context context, ArrayList<Integer> adList, ArrayList<String> nameList, ImageCycleViewListener imageCycleViewListener) {
...
//			return mAdList.size();
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			int imageId = mAdList.get(position % mAdList.size());
			View view;
	...
	public interface ImageCycleViewListener {
		 ...
		 */
		void displayImage(int imageId, ImageView imageView);
